...
[3중 호환성 패치 + GPU ID 매핑 + 타임코드 확장 마스터 버전 (Torchaudio Backend 완전 방어)]
...
# =========================================================================
# 🛡️ [마스터 가드 1] Torchaudio 최신 버전 삭제 명령어 및 모듈 실시간 가상화 (완전 방어)
# =========================================================================
import torchaudio
...
# 💡 [핵심 추가] 최신 torchaudio에서 통째로 날아간 torchaudio.backend 서브모듈 의존성 가상 주입
